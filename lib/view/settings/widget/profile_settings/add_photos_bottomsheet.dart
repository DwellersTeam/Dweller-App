...
Future<void> addDisplayPhotosBottomsheet({
  required BuildContext context,
  required SettingsController controller,
  required CreateProfileController profileController,
  required CreateProfileService profileService,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              profileController.getImages(
                                context: context, 
                                onSuccess: () {
                                  profileService.updateUserDisplayPhotosEndpoint(
                                    context: context,
                                    pictures: profileController.selectedImagesUrl, 
                                    onSuccess: () {
                                      profileController.selectedImagesUrl.clear();
                                      profileController.selectedImages.clear();
                                      onRefresh();
                                      Get.back();
                                      successBottomsheet(
                                        context: context,
                                        title: 'Display pictures updated successfully'
                                      );
                                    }
                                  );
                                },
                                onFailure: () {
                                  ...
                                  showMySnackBar(
                                    ...
                                    message: "failed to upload images to server"
                                  );
                                }
                              );
                            },
