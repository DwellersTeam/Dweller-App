...
import 'package:dweller/view/chat/message_widget/host_property_by_id.dart';
...
class GetHostProfile extends StatefulWidget {
  const GetHostProfile({super.key, required this.userId});
  final String userId;
  

  @override
  State<GetHostProfile> createState() => _GetHostProfileState();
}

class _GetHostProfileState extends State<GetHostProfile> with SingleTickerProviderStateMixin {
                ...
                children: [
                  ...
                  Expanded(
                    child: TabBarView(
                      ...
                      physics: const BouncingScrollPhysics(),
                      children: [
                        ProfileInfoForUser(userId: widget.userId),
                        HostPropertyInfoById(userId: widget.userId,)
                      ]
                    ),
                  ),
