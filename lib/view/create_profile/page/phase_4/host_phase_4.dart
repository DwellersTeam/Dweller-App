...
import 'package:dweller/view/create_profile/page/phase_5/host_phase_5.dart';
...
class HostPhase4Page extends StatefulWidget {
  const HostPhase4Page({super.key, required this.firstname, required this.authProvider});
  final String firstname;
  final String authProvider;

  @override
  State<HostPhase4Page> createState() => _HostPhase4PageState();
}

class _HostPhase4PageState extends State<HostPhase4Page> {
                                    ...
                                    service.addToMap(
                                      ...
                                      onSuccess: () {
                                        ...
                                        createProfileController.secondSubImageController.clear();
                                          ...
                                          Get.offAll(() => HostPhase5Page(firstname: widget.firstname,));
                                        },
                                      );
                                    });
