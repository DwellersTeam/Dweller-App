...
import 'package:dweller/view/create_profile/page/phase_4/host_phase_4.dart';
...
class HostPhase3Page extends StatelessWidget {
  HostPhase3Page({super.key, required this.firstname, required this.authProvider});
                        ...
                        () {
                          return createProfileController.showMoreLivelihood.value ? Padding(
                            ...
                            child: ProfileTextField(
                              ...
                              onChanged: (val) {
                                createProfileController.moreLivelihoodController.text = val;
                                print(createProfileController.moreLivelihoodController.text);
                              }, 
                        ...
                        () {
                          return createProfileController.showMoreSexualOrientation.value ? Padding(
                            ...
                            child: ProfileTextField(
                              icon: Icons.more_horiz_rounded,
                              onChanged: (val) {
                                createProfileController.moreSexualOrientationController.text = val;
                                print(createProfileController.moreSexualOrientationController.text);
                              }, 
                              hintText: 'Type it here', 
                              keyboardType: TextInputType.text,
                              textInputAction: TextInputAction.next, 
                        ...
                        () {
                          return Padding(
                            ...
                            child: CustomNextButton(
                              ...
                              () {
                                Get.to(()=> HostPhase4Page(firstname: firstname, authProvider: authProvider,));
                              }
                              :() {
                                debugPrint("nothing");
                              },
