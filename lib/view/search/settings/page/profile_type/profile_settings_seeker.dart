...
import 'package:dweller/view/search/settings/page/edit_bio_settings.dart';
import 'package:dweller/view/search/settings/page/edit_hobbies_lifestyle_settings.dart';
import 'package:dweller/view/search/settings/page/main/settings_page.dart';
...
import 'package:dweller/view/search/settings/widget/profile_settings/add_photos_bottomsheet.dart';
import 'package:dweller/view/search/settings/widget/profile_settings/bio_card.dart';
import 'package:dweller/view/search/settings/widget/profile_settings/display_pictures_list.dart';
import 'package:dweller/view/search/settings/widget/profile_settings/hobbies_card.dart';
import 'package:dweller/view/search/settings/widget/profile_settings/profile_card.dart';
import 'package:dweller/view/search/settings/widget/profile_settings/update_displaypic_bottomsheet.dart';
...
class ProfileSettingSeeker extends StatefulWidget {
  const ProfileSettingSeeker({super.key, required this.context,});
  ...
  final Future<UserModel> refresh;
  final List<dynamic> pictures;*/
  final BuildContext context;


  @override
  State<ProfileSettingSeeker> createState() => _ProfileSettingSeekerState();
}

class _ProfileSettingSeekerState extends State<ProfileSettingSeeker> {
  ...
  void initState() {
    ...
    userFuture = _refresh();  //profileService.getCurrentUserEndpoint(context);
    //_refresh();
    super.initState();
  }
