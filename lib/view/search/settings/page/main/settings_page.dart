...
import 'package:dweller/view/search/settings/page/account_settings.dart';
import 'package:dweller/view/search/settings/page/kyc_settings.dart';
import 'package:dweller/view/search/settings/page/legal_settings.dart';
import 'package:dweller/view/search/settings/page/profile_type/profile_settings_seeker.dart';
import 'package:dweller/view/search/settings/widget/kyc_settings/kyc_card.dart';
import 'package:dweller/view/search/settings/widget/general/selector.dart';
import 'package:dweller/view/search/settings/widget/general/switch_widget.dart';
import 'package:dweller/view/search/settings/widget/logout/logout_overlay.dart';
